...
class RtmpWriter:
    ...
    def send_packet(self, packet):
        ...
        """
        # If the packet was set up, then make sure we have the body buffer ready to write.
        if packet.body_buffer is not None:
            ...
            # Write the message chunks into the stream.
            ...
            print('The packet was not sent since it was not setup', packet.header)
